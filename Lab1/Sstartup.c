...
#include <stdint.h>
#define ISR_VECTOR_SIZE_WORDS 100
...
void i2c3_event_handler(void) __attribute__((weak, alias("default_handler")));
void i2c3_error_handler(void) __attribute__((weak, alias("default_handler")));
...
uint32_t isr_vector[ISR_VECTOR_SIZE_WORDS] __attribute__((section(".isr_vector"))) = {
  ...
  (uint32_t)&i2c1_event_handler,
  (uint32_t)&i2c1_error_handler,
  (uint32_t)&i2c2_event_handler,
  (uint32_t)&i2c2_error_handler,
  ...
  (uint32_t)&i2c3_event_handler,
  (uint32_t)&i2c3_error_handler,
